...
db = Database('/home/str/20ekb/cfg/database')
    ...
    async def buy_product_task(message: Message):
        ...
        if "/buy_product_0" in message.text:
            ...
            if f"/buy_product_12" not in message.text:
                ...
                await message.answer(MESSAGES[f"buy_product_{id_product[2]}"] % (f"{price_product[0]}", rub_coin, district_name, number_order, number_order), reply_markup=BUTTON_TYPES["BTN_HOME_2"])
